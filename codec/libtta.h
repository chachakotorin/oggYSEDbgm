...
#define TTA_EXTERN_API //èCê≥ by Kobarin
//#define TTA_ALIGNED(n) __declspec(align(n))
#define TTA_ALIGNED(n) //èCê≥ by Kobarin
#endif
...
namespace tta
{
	...
	public:
		...
		void set_position(TTAuint32 seconds, TTAuint64 *new_pos_sample);//by Kobarin(new_pos ÇÃíPà ÇïbÇ©ÇÁÉTÉìÉvÉãêîÇ…ïœçX)
		TTAuint32 get_rate();
