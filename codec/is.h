...
static __inline int8_t is_intensity(ic_stream *ics, uint8_t group, uint8_t sfb)
{
...
static __inline int8_t invert_intensity(ic_stream *ics, uint8_t group, uint8_t sfb)
{
